/*
* NOTICE: This version of the Gamer.h file has been modified by Matthew Petry (fireTwoOneNine)
...
public:
	...
	void stopTone();
	void printString(String string, int delaytime = 70);
	void appendColumn(byte* screen, byte col, int delaytime);
